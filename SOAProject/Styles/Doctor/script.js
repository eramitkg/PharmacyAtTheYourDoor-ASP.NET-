$(document).ready(function () {
    ...
    $('.fa-plus').on('click', function () {
        ...
        col.innerHTML += `<input class="form-control" type="text" placeholder="İlaç" style="text-align: center;">`; // put data in first column
        col1.innerHTML += `<input class="form-control" type="text" placeholder="Türü" style="text-align: center;">`; // put data in second column
        col2.innerHTML += `<input class="form-control" type="text" placeholder="Kullanım" style="text-align: center;">`;
